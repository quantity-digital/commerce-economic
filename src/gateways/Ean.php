...
namespace QD\commerce\economic\gateways;
...
class Ean extends Gateway
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate('commerce-economic/gateways/settings', ['gateway' => $this, 'statusOptions' => $statusOptions]);
    }
